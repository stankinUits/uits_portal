...
} from "@app/views/uits/public/educational-activities/schedule/exam-schedule/exam-schedule.component";
...
const routes: Routes = [
  ...
  { path: 'schedule/schedule-exams', component: ExamScheduleComponent}
];
